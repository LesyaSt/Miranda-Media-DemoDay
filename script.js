  ...
  async function loadProducts(filter = "all") {
    try {
      ...
      filteredProducts.forEach((product) => {
        ...
        const labelNew = product.labelNew
          ? `<span class="label-new">${product.labelNew}</span>`
          : "";
        const labelSale = product.labelSale
          ? `<span class="label-sale">${product.labelSale}</span>`
          : "";
